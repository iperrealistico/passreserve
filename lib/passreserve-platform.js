...
export const emailTemplateCatalog = [
  ...
  },
  {
    ...
    preview:
      "Names the event and occurrence first, then explains the confirmation step, payment split, and whether the organizer prepared the registration.",
    placeholders: [
      "{{event_name}}",
      "{{occurrence_label}}",
      "{{confirmation_url}}",
  ...
  },
  {
    ...
    preview:
      "Keeps the registration code, event logistics, origin note, and next arrival guidance in the first screenful.",
    placeholders: [
      "{{registration_code}}",
      "{{event_name}}",
      "{{venue_name}}",
  ...
  {
    id: "attendee_payment_requested",
    audience: "Attendee",
    category: "Payments",
    subject: "Complete payment for your Passreserve registration",
    trigger: "An organizer creates a registration manually and asks the attendee to complete the online amount",
    preview:
  ...
  },
  {
    ...
    preview:
      "Gives organizers the attendee name, quantity, source/origin, and the current payment state without rental-era wording.",
    placeholders: [
      "{{organizer_name}}",
      "{{event_name}}",
      "{{attendee_name}}",
