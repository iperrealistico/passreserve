...
export const platformAdminPhase = {
  label: "Team tools",
  title: "Host requests, emails, settings, and service status",
  summary:
    "Passreserve.com keeps host requests, emails, settings, logs, and service status together for the team supporting hosts and guests."
};
...
export const platformAdminGuidance = [
  ...
  {
    title: "Service checks stay practical",
    detail:
      "Host requests, emails, delivery status, and service checks live together so a small team can respond quickly."
  }
];
...
export const aboutPageStory = {
  ...
  sections: [
    ...
    {
      id: "hosts-and-support",
      title: "Hosts and the support team stay aligned behind the scenes.",
      detail:
        "Host dashboards and team tools use the same event language, so requests, emails, dates, and payments stay easy to follow.",
      bullets: [
        "Host requests, about-page content, and emails live in one team area.",
        "Dashboard, calendar, registrations, payments, and scheduling stay connected for each host.",
        "Service status stays visible to the support team without leaking that language into public pages."
      ]
    }
  ],
  faq: [
...
export async function getPlatformOverview() {
  ...
  return {
    ...
    releaseLabel: "Host requests, emails, and service status",
    summary: {
      organizerCount,
      eventCount,
      occurrenceCount,
    ...
    attentionQueue: [
      ...
      },
      {
        ...
        detail:
          "Service checks keep payment readiness beside live-site status so the team does not overstate what is available.",
        href: "/admin/health",
        cta: "Open service status"
      }
    ],
    releaseTracks: [
      {
      ...
      {
        title: "Emails and service checks",
        detail:
          "Email templates, host requests, recent activity, and service status are grouped so the team can respond quickly."
      }
    ]
  };
}
