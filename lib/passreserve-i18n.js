...
const dictionaries = {
  en: {
    ...
    email: {
      ...
      outboundOnly:
        "The shared mailbox now stores inbound Resend messages, reply history, and email templates in one place."
    },
    health: {
  ...
  it: {
    ...
    email: {
      ...
      outboundOnly:
        "La mailbox condivisa ora raccoglie messaggi inbound da Resend, cronologia reply e template nello stesso punto."
    },
    health: {
