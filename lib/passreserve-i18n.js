...
const dictionaries = {
  en: {
    ...
    home: {
      ...
      organizerAccessLabel: "Organizer access",
    ...
    organizerAccessPage: {
      title: "Open your organizer login",
      summary:
        "Organizer admins sign in through their organizer slug. Enter the slug we shared with you and we will open the correct login page.",
      slugLabel: "Organizer slug",
      slugPlaceholder: "example",
      submit: "Open organizer login",
      backToSite: "Back to site",
      helper:
        "Example: if your organizer page is passreserve.com/example, your admin login is passreserve.com/example/admin/login.",
      missing: "Enter your organizer slug to continue.",
      platformLabel: "Platform team",
      platformTitle: "Need the platform admin login instead?",
      platformSummary:
        "Platform owners and internal admins use a separate team login from organizer admins.",
      platformCta: "Open platform admin"
    },
    footer: {
      summary: "Minimal event registration software for local organizers.",
      rights: "All rights reserved.",
      note: "Built for local organizers and guests."
    },
    events: {
    ...
    registration: {
      ...
      bookingLanguageTitle: "Booking language",
      bookingLanguageSummary:
        "Choose the language for this registration before continuing. That preference stays attached to the booking.",
      bookingLanguageCurrent: "Current choice",
      steps: {
        occurrence: "Date",
        ticket: "Ticket",
    ...
    email: {
      ...
      outboundOnly:
        "Review transactional delivery logs here, and send direct organizer emails from each organizer detail page."
    },
    health: {
  ...
  it: {
    ...
    home: {
      ...
      organizerAccessLabel: "Accesso organizer",
    ...
    organizerAccessPage: {
      title: "Apri il login organizer",
      summary:
        "Gli admin organizer accedono tramite lo slug del proprio organizer. Inserisci lo slug condiviso con te e apriremo la pagina login corretta.",
      slugLabel: "Slug organizer",
      slugPlaceholder: "example",
      submit: "Apri login organizer",
      backToSite: "Torna al sito",
      helper:
        "Esempio: se la tua pagina organizer è passreserve.com/example, il login admin corretto è passreserve.com/example/admin/login.",
      missing: "Inserisci lo slug organizer per continuare.",
      platformLabel: "Team piattaforma",
      platformTitle: "Ti serve invece il login admin piattaforma?",
      platformSummary:
        "Owner e admin interni della piattaforma usano un login separato rispetto agli admin organizer.",
      platformCta: "Apri admin piattaforma"
    },
    footer: {
      summary: "Software minimale per registrazioni eventi dedicato agli organizer locali.",
      rights: "Tutti i diritti riservati.",
      note: "Pensato per organizer locali e ospiti."
    },
    events: {
    ...
    registration: {
      ...
      bookingLanguageTitle: "Lingua della registrazione",
      bookingLanguageSummary:
        "Scegli la lingua di questa registrazione prima di proseguire. Questa preferenza resta collegata alla prenotazione.",
      bookingLanguageCurrent: "Scelta attuale",
      steps: {
        occurrence: "Data",
        ticket: "Ticket",
    ...
    email: {
      ...
      outboundOnly:
        "Qui controlli i log di invio; le email dirette agli organizer partono dalla loro scheda admin."
    },
    health: {
...
export async function getTranslations(preferredLocale = null) {
