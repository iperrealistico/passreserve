...
const dictionaries = {
  en: {
    ...
    organizerAccessPage: {
      ...
      slugPlaceholder: "sillico",
      submit: "Open organizer login",
      backToSite: "Back to site",
      helper:
        "Example: if your organizer page is passreserve.com/sillico, your admin login is passreserve.com/sillico/admin/login.",
  ...
  it: {
    ...
    organizerAccessPage: {
      ...
      helper:
        "Esempio: se la tua pagina organizer è passreserve.com/sillico, il login admin corretto è passreserve.com/sillico/admin/login.",
