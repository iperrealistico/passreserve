...
export const paymentPhase = {
  ...
  summary:
    "Passreserve.com now hands payment-required registrations into Stripe Checkout, returns through success and cancel routes, and logs webhook reconciliation metadata without skipping the existing hold-and-confirm lifecycle."
};
...
export const stripeEnvironmentRequirements = [
  {
    ...
    requiredFor: "Live Checkout Session creation",
    optional: false
  },
  {
    key: "STRIPE_WEBHOOK_SECRET",
    label: "Stripe webhook secret",
    requiredFor: "Webhook signature verification and trusted reconciliation logging",
    optional: false
  },
  {
