...
const organizerCatalog = [
  ...
  },
  {
    ...
    region: "Emilia-Romagna",
    tagline:
      "A compact local organizer page with direct dates, lean copy, and a quieter registration flow.",
    description:
      "Sillico uses Passreserve as a minimal public surface: venue, dates, event details, and registration without extra social framing.",
    themeTags: ["community table", "test format", "local events"],
    venue: {
      title: "Sillico Studio",
      detail:
        "A small-format venue used for proofing the public organizer flow, with direct arrival notes and no extra presentation layers.",
      mapLabel: "Open Sillico Studio map",
      mapHref: "https://maps.google.com/?q=Bologna+Sillico+Studio"
    },
    contact: {
      email: "hello@sillico.passreserve.com",
      phone: "+39 051 700 701"
    },
    photoStory: [
      buildPhoto(
        "Entry table",
        "The host page should stay factual and easy to scan.",
        "linear-gradient(135deg, rgba(23, 41, 30, 0.98), rgba(69, 103, 82, 0.85))"
      )
    ],
    policies: [
      "This sample organizer keeps the public flow intentionally minimal and date-first.",
      "Online collection is disabled so the event remains a straightforward registration example.",
      "Organizer notes are shown only where they help a real attendee decision."
    ],
    faq: [
      {
        question: "Why is this organizer page so minimal?",
        answer:
          "Because it is meant to validate the more brutal MTB Reserve-inspired public flow."
      }
    ],
    events: [
      {
        slug: "prova",
        title: "Prova",
        category: "Sillico da Scoprire",
        summary:
          "A compact sample event used to validate the live public flow with direct dates and a minimal registration surface.",
        description:
          "A deliberately small public event page with a short summary, a clear date list, and a direct registration path.",
        audience:
          "Best for validating local organizer flows, small-format events, and minimal public booking surfaces.",
        duration: "1h 45m",
        venueDetail:
          "Runs at Sillico Studio with a short briefing, light host notes, and no extra promotional blocks.",
        basePrice: 9.96,
        prepayPercentage: 0,
        highlights: [
          "Minimal public event page",
          "Direct date selection",
          "Simple attendee registration flow"
        ],
        included: [
          "Published date selection",
          "Attendee questionnaire",
          "Operationally clear confirmation step"
        ],
        gallery: [
          buildPhoto(
            "Sillico sample flow",
            "A quiet test event for live routing checks.",
            "linear-gradient(135deg, rgba(34, 62, 46, 0.95), rgba(154, 182, 164, 0.8))"
          )
        ],
        policies: [
          "Registration remains open only on published dates.",
          "This sample route is intended for end-to-end public flow checks.",
          "Any unpaid amount is settled at the venue."
        ],
        faq: [
          {
            question: "Is this a real live event?",
            answer:
              "It is a compact sample event kept online to validate public routing and presentation."
          }
        ],
        occurrences: [
          createOccurrence({
            id: "sillico-prova-2026-05-08",
            startsAt: "2026-05-08T19:00:00+02:00",
            label: "08 May 2026",
            time: "19:00 to 20:45",
            capacity: "16 spots open",
            note: "Sample public date kept available for live checks."
          }),
          createOccurrence({
            id: "sillico-prova-2026-05-22",
            startsAt: "2026-05-22T19:15:00+02:00",
            label: "22 May 2026",
            time: "19:15 to 21:00",
            capacity: "12 spots open",
            note: "Second sample date for routing and registration tests."
          })
        ]
      }
    ]
