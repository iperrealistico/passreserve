...
function buildOperatorLine(locale = "en") {
  if (locale === "it") {
    return `${PASSRESERVE_LEGAL_ENTITY.businessName} · P. IVA ${PASSRESERVE_LEGAL_ENTITY.vatNumber}`;
  }

  return `${PASSRESERVE_LEGAL_ENTITY.businessName} · VAT ${PASSRESERVE_LEGAL_ENTITY.vatNumber}`;
}
...
export function getOperatorFooterLine(locale = "en") {
  if (locale === "it") {
    return `${buildOperatorLine("it")} · ${buildAddressLine("it")}`;
  }

  return `${buildOperatorLine("en")} · ${buildAddressLine("en")}`;
}
