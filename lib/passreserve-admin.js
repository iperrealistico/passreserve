...
function buildAdminEvent(organizer, event, eventIndex) {
  ...
  return {
    ...
    organizerNotes:
      event.highlights[1] ??
      "Organizer admins can keep the public promise, default venue, and schedule shape aligned here.",
    cancellationPolicy:
      event.policies[0] ??
...
export const organizerAdminPhase = {
  label: "Phase 07",
  title: "Organizer admin event catalog and occurrence management",
  summary:
    "Passreserve.com now adds the organizer-admin shell for event catalog CRUD, recurring occurrence planning, per-date overrides, and venue-level schedule conflict handling."
};
...
export const organizerAdminGuidance = [
  {
    title: "Inventory becomes event catalog",
    detail:
      "Event defaults now live in organizer-admin forms with public visibility, venue, pricing, and prepayment rules instead of bike stock fields."
  },
  {
    title: "Occurrences are first-class",
    detail:
  ...
  {
    title: "Conflict handling stays practical",
    detail:
