...
export const PUBLIC_READ_MODEL_VERSION = Object.freeze({
  LEGACY: "legacy",
  V2: "v2"
});
...
export function getPublicReadModelVersion(env = process.env) {
  return String(env.PASSRESERVE_PUBLIC_READ_MODEL || "")
    .trim()
    .toLowerCase() === PUBLIC_READ_MODEL_VERSION.V2
    ? PUBLIC_READ_MODEL_VERSION.V2
