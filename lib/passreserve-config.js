...
export function getStorageSummary() {
  ...
  if (hasDatabase()) {
    return {
      mode,
      label: "Runtime file store (database fallback)",
      detail:
        "A database is configured, but this runtime detected an incompatible Passreserve schema and automatically fell back to the file store."
    };
  }
